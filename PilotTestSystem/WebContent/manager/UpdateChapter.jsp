...
<body>
<div class="middle">
<form action="DealChapterServlet?param=update" method="post">
	        <div class="create">
	    	    <div class="head">
                    <h3>添加章节</h3>
	    	    </div>
                ...
                <table class="table table-striped" >
                	...
                	<tbody>
                		<tr>
                			<td><input type="text" name="chapterIndex" readonly="true" value="<%=chapter.getChapterId()%>"/></td>
                			<td><input type="text" name="chapterName"  value="<%=chapter.getName()%>" /></td>
                			<td><input type="text" name="chapterIntro"  value="<%=chapter.getComment()%>"/></td>
                		</tr>
                	</tbody>
                </table>
	    	</div>
